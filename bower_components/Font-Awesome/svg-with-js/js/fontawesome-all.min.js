...
!function() {
    ...
    var e = (l.navigator || {}).userAgent, a = void 0 === e ? "" : e, m = l, n = h, s = v, t = z, r = !!m.document, f = !!n.documentElement && !!n.head && "function" == typeof n.addEventListener && "function" == typeof n.createElement, p = ~a.indexOf("MSIE") || ~a.indexOf("Trident/"), M = "___FONT_AWESOME___", b = 16, i = "svg-inline--fa", g = "data-fa-i2svg", H = "data-fa-pseudo-element", o = "fontawesome-i2svg", V = function() {
        try {
            return !1;
        } catch (c) {
            return !1;
    ...
    N[M].shims || (N[M].shims = []);
    var E = N[M], P = [], T = !1;
    f && ((T = (n.documentElement.doScroll ? /^loaded|^c/ : /^loaded|^i|^c/).test(n.readyState)) || n.addEventListener("DOMContentLoaded", function c() {
    ...
    var Q = {
        ...
        var l = c.children, h = c.attributes, v = c.main, z = c.mask, e = c.transform, a = v.width, m = v.icon, s = z.width, t = z.icon, n = J({
            transform: e,
            containerWidth: s,
            iconWidth: a
        }), r = {
        ...
        if (G(a) && h.found && !v.found) {
            var m = h.width / h.height / 2, s = .5;
            z.style = K(k({}, e, {
                "transform-origin": m + a.x / 16 + "em " + (s + a.y / 16) + "em"
            }));
        }
        return [ {
            tag: "svg",
    ...
    function hc(c) {
        var l = c.icons, h = l.main, v = l.mask, z = c.prefix, e = c.iconName, a = c.transform, m = c.symbol, s = c.title, t = c.extra, n = c.watchable, r = void 0 !== n && n, f = v.found ? v : h, M = f.width, i = f.height, H = "fa-w-" + Math.ceil(M / i * 16), o = [ O.replacementClass, e ? O.familyPrefix + "-" + e : "", H ].concat(t.classes).join(" "), V = {
            children: [],
            attributes: k({}, t.attributes, {
                "data-prefix": z,
                "data-icon": e,
                class: o,
                role: "img",
        ...
        r && (V.attributes[g] = ""), s && V.children.push({
            tag: "title",
            attributes: {
                id: V.attributes["aria-labelledby"] || "title-" + F()
            },
            children: [ s ]
        });
        var C = k({}, V, {
        ...
        return C.children = u, C.attributes = d, m ? lc(C) : cc(C);
    }
    function vc(c) {
        var l = c.content, h = c.width, v = c.height, z = c.transform, e = c.title, a = c.extra, m = c.watchable, s = void 0 !== m && m, t = k({}, a.attributes, e ? {
            title: e
        } : {}, {
            class: a.classes.join(" ")
        });
        s && (t[g] = "");
        var n, r, f, M, i, H, o, V, C, L = k({}, a.styles);
        G(z) && (L.transform = (r = (n = {
            transform: z,
            startCentered: !0,
            width: h,
            height: v
        }).transform, f = n.width, M = void 0 === f ? b : f, i = n.height, H = void 0 === i ? b : i, 
        o = n.startCentered, C = "", C += (V = void 0 !== o && o) && p ? "translate(" + (r.x / I - M / 2) + "em, " + (r.y / I - H / 2) + "em) " : V ? "translate(calc(-50% + " + r.x / I + "em), calc(-50% + " + r.y / I + "em)) " : "translate(" + r.x / I + "em, " + r.y / I + "em) ", 
        C += "scale(" + r.size / I * (r.flipX ? -1 : 1) + ", " + r.size / I * (r.flipY ? -1 : 1) + ") ", 
        C += "rotate(" + r.rotate + "deg) "), L["-webkit-transform"] = L.transform);
        var u = K(L);
    ...
    var zc = function() {}, ec = O.measurePerformance && t && t.mark && t.measure ? t : {
        ...
        var z, e, a, m, s, t = Object.keys(c), n = t.length, r = void 0 !== v ? (m = l, 
        s = v, function(c, l, h, v) {
            return m.call(s, c, l, h, v);
        }) : l;
        for (void 0 === h ? (z = 1, a = c[t[0]]) : (z = 0, a = h); z < n; z++) a = r(a, c[e = t[z]], e, c);
        return a;
    ...
    function uc(c) {
        var h, l = c.tag, v = c.attributes, z = void 0 === v ? {} : v, e = c.children, a = void 0 === e ? [] : e;
        return "string" == typeof c ? U(c) : "<" + l + " " + (h = z, Object.keys(h || {}).reduce(function(c, l) {
            return c + (l + '="') + U(h[l]) + '" ';
        }, "").trim()) + ">" + a.map(uc).join("") + "</" + l + ">";
    }
    var dc = function() {};
    function pc(c) {
    ...
    function gc(h, c) {
        ...
        0 === h.length ? v() : (m.requestAnimationFrame || function(c) {
            return c();
        })(function() {
    ...
    var Sc = function(c) {
        var l, h, v, z, e = c.getAttribute("data-prefix"), a = c.getAttribute("data-icon"), m = void 0 !== c.innerText ? c.innerText.trim() : "", s = Cc(W(c));
        return e && a && (s.prefix = e, s.iconName = a), s.prefix && 1 < m.length ? s.iconName = (v = s.prefix, 
        z = c.innerText, Mc[v][z]) : s.prefix && 1 === m.length && (s.iconName = (l = s.prefix, 
        h = function(c) {
            for (var l = "", h = 0; h < c.length; h++) l += ("000" + c.charCodeAt(h).toString(16)).slice(-4);
            return l;
        }(c.innerText), fc[l][h])), s;
    }, xc = function(c) {
        var l = {
            size: 16,
            x: 0,
    ...
    function Wc(c) {
        var l, h, v, z, e, a, m, s, t, n, r, f, M, i, H, o, V, C, L, u = (h = Sc(l = c), 
        v = h.iconName, z = h.prefix, e = h.rest, a = kc(l), m = Ac(l), s = qc(l), t = Oc(l), 
        n = jc(l), {
            iconName: v,
        ...
        return ~u.extra.classes.indexOf(Dc) ? function(c, l) {
            var h = l.title, v = l.transform, z = l.extra, e = null, a = null;
            if (p) {
                var m = parseInt(getComputedStyle(c).fontSize, 10), s = c.getBoundingClientRect();
                e = s.width / m, a = s.height / m;
            }
        ...
        }(c, u) : (r = c, M = (f = u).iconName, i = f.title, H = f.prefix, o = f.transform, 
        V = f.symbol, C = f.mask, L = f.extra, [ r, hc({
            icons: {
                main: Rc(M, H),
    ...
    function Uc(c) {
        if (f) {
            ...
            yc = !0, function() {
                R(c.querySelectorAll("*")).forEach(function(a) {
                    [ ":before", ":after" ].forEach(function(l) {
                        var c = m.getComputedStyle(a, l), h = c.getPropertyValue("font-family").match(Xc), v = R(a.children).filter(function(c) {
                        ...
                        Yc(v), v = null), h && !v) {
                            ...
                            e.setAttribute("class", "" + Fc[h[1]]), e.setAttribute(H, l), e.innerText = 3 === z.length ? z.substr(1, 1) : z, 
                            ":before" === l ? a.insertBefore(e, a.firstChild) : a.appendChild(e);
                        }
                    });
                });
            }(), yc = !1, l();
    ...
    function Kc(c) {
        ...
        if (f) {
            var h = n.documentElement.classList, v = function(c) {
                ...
                return h.remove(o + "-" + c);
            }, e = Object.keys(Bc), a = [ "." + Dc + ":not([" + g + "])" ].concat(e.map(function(c) {
                return "." + c + ":not([" + g + "])";
            })).join(", ");
            if (0 !== a.length) {
                ...
                if (0 < m.length) {
                    ...
                    var s = sc.begin("onTree"), t = m.reduce(function(c, l) {
                        try {
                            var h = Wc(l);
                            h && c.push(h);
                        } catch (c) {
        ...
        return w(c, [ {
            ...
            value: function() {
                ...
                Object.keys(z).forEach(function(c) {
                    l.definitions[c] = k({}, l.definitions[c] || {}, z[c]), function c(l, v) {
                        var h = Object.keys(v).reduce(function(c, l) {
                            var h = v[l];
                            return h.icon ? c[h.iconName] = h.icon : c[l] = h, c;
                        }, {});
                        "function" == typeof E.hooks.addPack ? E.hooks.addPack(l, h) : E.styles[l] = k({}, E.styles[l] || {}, h), 
                        "fas" === l && c("fa", v);
                    }(c, z[c]);
                });
            }
            ...
            value: function(e, c) {
                var a = c.prefix && c.iconName && c.icon ? {
                    0: c
                } : c;
                return Object.keys(a).map(function(c) {
                    var l = a[c], h = l.prefix, v = l.iconName, z = l.icon;
                    e[h] || (e[h] = {}), e[h][v] = z;
                }), e;
            }
        } ]), c;
    ...
    var vl, zl = new Qc(), el = (vl = function(c) {
        var l = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {}, h = l.transform, v = void 0 === h ? B : h, z = l.symbol, e = void 0 !== z && z, a = l.mask, m = void 0 === a ? null : a, s = l.title, t = void 0 === s ? null : s, n = l.classes, r = void 0 === n ? [] : n, f = l.attributes, M = void 0 === f ? {} : f, i = l.styles, H = void 0 === i ? {} : i;
        if (c) {
            var o = c.prefix, V = c.iconName, C = c.icon;
            return ll(k({
                type: "icon"
            }, c), function() {
                return cl(), O.autoA11y && (t ? M["aria-labelledby"] = O.replacementClass + "-title-" + F() : M["aria-hidden"] = "true"), 
                hc({
                    icons: {
                        main: Zc(C),
                        mask: m ? Zc(m.icon) : {
        ...
        icon: el,
        text: function(c) {
            var l = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {}, h = l.transform, v = void 0 === h ? B : h, z = l.title, e = void 0 === z ? null : z, a = l.classes, m = void 0 === a ? [] : a, s = l.attributes, t = void 0 === s ? {} : s, n = l.styles, r = void 0 === n ? {} : n;
            return ll({
                type: "text",
                content: c
            }, function() {
    ...
    Object.defineProperty(al, "config", {
        ...
        r && (m.FontAwesome || (m.FontAwesome = al), _(function() {
            0 < Object.keys(E.styles).length && ml(), O.observeMutations && "function" == typeof MutationObserver && function(c) {
                if (s) {
                    var z = c.treeCallback, e = c.nodeCallback, a = c.pseudoElementsCallback;
                    wc = new s(function(c) {
                        yc || R(c).forEach(function(c) {
                            if ("childList" === c.type && 0 < c.addedNodes.length && !pc(c.addedNodes[0]) && (O.searchPseudoElements && a(c.target), 
                            z(c.target)), "attributes" === c.type && c.target.parentNode && O.searchPseudoElements && a(c.target.parentNode), 
                    ...
                    }), f && wc.observe(n.getElementsByTagName("body")[0], {
                        childList: !0,
                        attributes: !0,
                        characterData: !0,
                        subtree: !0
